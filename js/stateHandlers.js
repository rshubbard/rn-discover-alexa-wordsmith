...
const API_KEY_HERE = '4572339f26f38d4bd216a2d401238d1b9818b0ff0ab7206799636e0e82427194'
var Wordsmith = require('wordsmith-node-sdk')(API_KEY_HERE, 'reverbnation');
...
var stateHandlers = {
    startModeIntentHandlers : Alexa.CreateStateHandler(constants.states.START_MODE, {
        ...
        'AMAZON.HelpIntent' : function () {
            var message = 'Welcome to ReverbNation Discover. You can say, play the audio, to begin playing.';
    ...
    playModeIntentHandlers : Alexa.CreateStateHandler(constants.states.PLAY_MODE, {
        ...
        'LaunchRequest' : function () {
            ...
            if (this.attributes['playbackFinished']) {
                this.handler.state = constants.states.START_MODE;
                message = 'Welcome to the ReverbNation Discover. You can say, play the audio to begin the podcast.';
        ...
        'AMAZON.HelpIntent' : function () {
            ...
            var message = 'You are listening to the ReverbNation Discover. You can say, Next or Previous to navigate through the playlist. ' +
        ...
        play: function () {
            ...
            Wordsmith.projects.find('test-test')
              .then(function(project) {
                ...
                return project.templates.find('variability-v2');
              })
